...
| # | 위치 | 미주입 키 |
|:--:|---|---|
| 8 ✅ | API VM | ~~`ZDM_PACKAGE_PATH`, `ZDM_PACKAGE_SCRIPT`, `ZDM_META_CONNECT_TIMEOUT_SEC`, `ZDM_META_TOTAL_TIMEOUT_SEC`, `REDIS_TTL_ZDM_PACKAGE_SHA256`~~ → `zdm.yml`에 신설, playbook-api + app.env.j2 inject |
